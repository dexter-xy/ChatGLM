...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "ChatGLM")
if WEBUI_NAME != "ChatGLM":
    WEBUI_NAME += " (ChatGLM)"
...
OPENAI_API_KEY = os.environ.get("OPENAI_API_KEY", "151a749dbcbd458cb703f4980e5048c7.CVCU7bv6FgTJfIJJ")
OPENAI_API_BASE_URL = os.environ.get("OPENAI_API_BASE_URL", "https://open.bigmodel.cn/api/paas/v4")
...
DEFAULT_PROMPT_SUGGESTIONS = PersistentConfig(
    ...
    [
        {
            "title": ["构思一个故事", "主角是能在梦中旅行的侦探"],
            "content": "帮我构思一个故事大纲，主角是一名可以在别人梦境中穿梭的侦探，他需要解决一桩离奇的失踪案。",
        },
        {
            "title": ["写一首诗", "关于夏夜的星空"],
            "content": "请为我写一首关于夏夜星空的现代诗，风格要宁静而富有想象力。",
        },
        {
            "title": ["解释一个概念", "什么是\"第一性原理\"？"],
            "content": "用一个通俗易懂的比喻，向我解释什么是\"第一性原理\"，并举一个它在商业或科技领域的应用实例。",
        },
        {
            "title": ["帮我写封邮件", "向老板申请一天假期"],
            "content": "帮我草拟一封正式的电子邮件，向我的老板（[老板姓名]）申请下周五休假一天，理由是处理个人事务。",
        },
        {
            "title": ["编写一段代码", "用Python实现快速排序"],
            "content": "请用 Python 编写一个实现快速排序算法的函数，并加上清晰的注释来解释每一步的作用。",
        },
        {
            "title": ["比较技术方案", "比较Vue和React的优缺点"],
            "content": "作为一名前端开发者，请帮我详细比较一下 Vue 和 React 这两个框架在项目选型时的主要优缺点。",
        },
        {
            "title": ["制定一个计划", "为期三天的周末旅行计划"],
            "content": "请为我制定一个为期三天的周末旅行计划，目的地是杭州，我喜欢自然风光和当地美食，预算在2000元以内。",
        },
        {
            "title": ["如何开始健身", "帮我制定一个入门健身计划"],
            "content": "我是一个完全没有健身体验的新手，想开始锻炼身体。请为我制定一个为期一周的入门级家庭健身计划，不需要任何器械。",
        },
    ],
)
